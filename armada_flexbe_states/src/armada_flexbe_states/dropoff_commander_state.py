...
class DropoffCommanderState(EventState):
  '''
  ...
  def __init__(self):
          ...
          super(DropoffCommanderState, self).__init__(outcomes = ['continue', 'failed'],
                                                   input_keys = ['grasp_task_candidates', 'grasp_attempt'],
                                                   output_keys = ['grasp_task_candidates', 'target_pose_list', 'grasp_attempt'])

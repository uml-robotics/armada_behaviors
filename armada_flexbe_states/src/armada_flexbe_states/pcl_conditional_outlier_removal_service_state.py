...
class PCLConditionalOutlierRemovalServiceState(EventState):
        ...
        def __init__(self):
                ...
                super(PCLConditionalOutlierRemovalServiceState, self).__init__(outcomes = ['continue', 'failed'],
        ...
        def on_enter(self, userdata):
                ...
                Logger.loginfo('attempting to conditionally remove outliers from pointcloud...' )

...
from armada_bringup.srv import ActivateGripper
from std_msgs.msg import Empty

class ActivateGripperServiceState(EventState):
        '''
        ...
        def __init__(self):
                ...
                self._service_topic = '/activate_gripper'
                self._service = ProxyServiceCaller({self._service_topic: ActivateGripper})

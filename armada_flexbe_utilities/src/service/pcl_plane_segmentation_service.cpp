...
public:
  ...
  PlaneSegmentationService(ros::NodeHandle nh) :
    nh_(nh)
  {
    planeSegmentationService = nh.advertiseService("sac_segmentation_service", &PlaneSegmentationService::planeSegmentation, this);
  }
   ...
   */
  bool planeSegmentation(armada_flexbe_utilities::SacSegmentation::Request &req,

...
class RetreatCommanderState(EventState):
  '''
  ...
  def __init__(self):
          ...
          super(RetreatCommanderState, self).__init__(outcomes = ['continue', 'failed'],
                                                   input_keys = ['grasp_task_candidates', 'grasp_attempt'],
                                                   output_keys = ['target_pose_list', 'gripper_target_position'])
  ...
  def execute(self, userdata):
          ...
          userdata.target_pose_list.append(userdata.grasp_task_candidates[userdata.grasp_attempt].post)

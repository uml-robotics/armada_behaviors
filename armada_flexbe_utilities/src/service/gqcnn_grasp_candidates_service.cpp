...
#include "armada_flexbe_utilities/GQCNNGraspCandidates.h"
#include <gqcnn/GQCNNGrasp.h>

class GQCNNGraspCandidateService
{
protected:
...
public:
   ...
   */
  GQCNNGraspCandidateService(ros::NodeHandle nh) :
    nh_(nh)
  {
    getGraspCandidateService = nh.advertiseService("gpd_grasp_candidates", &GQCNNGraspCandidateService::GQCNNGraspCandidates, this);
  }
   ...
   */
  bool GQCNNGraspCandidates(armada_flexbe_utilities::GQCNNGraspCandidates::Request &req,
                          armada_flexbe_utilities::GQCNNGraspCandidates::Response &res)
  {
...
{
  ros::init(argc, argv, "gqcnn_grasp_candidates_service");
  ros::NodeHandle nh;

  GQCNNGraspCandidateService getGraspCandidateService = GQCNNGraspCandidateService(nh);
  ros::spin();

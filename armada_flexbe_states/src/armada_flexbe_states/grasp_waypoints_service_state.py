...
from armada_flexbe_utilities.srv import GraspWaypoints, GraspWaypointsResponse, GraspWaypointsRequest
...
class GraspWaypointsServiceState(EventState):
        ...
        def __init__(self):
                ...
                self._service = ProxyServiceCaller({self._service_topic: GraspWaypoints})
        ...
        def execute(self, userdata):
                ...
                request = GraspWaypointsRequest()
                request.pose_list = userdata.grasp_candidates
